...
下载 [collapsar\_week4\_linter.py](https://ossp.pengjunjie.com/collapsar-homework-3-9/collapsar_week4_linter.py) 和 [collapsar\_pre\_hw\_week4.py](https://ossp.pengjunjie.com/collapsar-homework-3-9/collapsar_pre_hw_week4.py)文件。拷贝到week3的文件夹中。

其中youyulab\_week3\_linter.py文件不需要改动

python 3.10及以上：

下载 [collapsar\_pre\_hw\_week4.py](https://ossp.pengjunjie.com/collapsar-homework-3-10/collapsar_pre_hw_week4.py)
