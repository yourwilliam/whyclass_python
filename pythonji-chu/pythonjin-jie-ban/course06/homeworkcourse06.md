...
下载 [collapsar\_week5\_linter.py](https://ossp.pengjunjie.com/collapsar-homework-3-9/collapsar_week5_linter.py) 和 [collapsar\_hw\_week5.py](https://ossp.pengjunjie.com/collapsar-homework-3-9/collapsar_hw_week5.py)文件。拷贝到week5的文件夹中。

其中youyulab\_week5\_linter.py文件不需要改动

python 3.10及以上：

下载 [collapsar\_hw\_week5.py](https://ossp.pengjunjie.com/collapsar-homework-3-10/collapsar_hw_week5.py)
