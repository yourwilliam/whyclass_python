...
下载 [collapsar\_week1\_linter.py](https://ossp.pengjunjie.com/collapsar-homework-3-9/collapsar_week1_linter.py) 和 [collapsar\_pre\_hw\_week1.py](https://ossp.pengjunjie.com/collapsar-homework-3-9/collapsar_pre_hw_week1.py)文件。拷贝到week1的文件夹中。

python 3.10 及以上:

请下载[collapsar\_pre\_hw\_week1](https://ossp.pengjunjie.com/collapsar-homework-3-10/collapsar_pre_hw_week1.py)
