...
下载 [collapsar\_week2\_linter.py](https://ossp.pengjunjie.com/collapsar-homework-3-9/collapsar_week2_linter.py)和 [collapsar\_hw\_week2.py](https://ossp.pengjunjie.com/collapsar-homework-3-9/collapsar_hw_week2.py)文件。拷贝到week2的文件夹中。

其中collapsar\_week2\_linter.py文件不需要改动

Python 3.10 及以上：

下载 [collapsar\_hw\_week2.py](https://ossp.pengjunjie.com/collapsar-homework-3-10/collapsar_hw_week2.py)
